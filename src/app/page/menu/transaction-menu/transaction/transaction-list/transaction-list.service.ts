...
export class TransactionListService {
   ...
   * @returns 
   */
  public getTransactionSlip(userId: string): Observable<transactionContents[]> {
    return this.http.get<transactionContents[]>(`${this.apiEndPoint + 'slipdetail/gettransactionslip/' + userId}`);
  }
